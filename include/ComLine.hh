...
/// Type 1) May accept an \e option \e argument.  
/// An option argument is the command line
/// token immediately following the option token.\n
/// Type 2) Requires an option argument.\n
/// Type 3) Non-optional option.  Application requires this option to 
/// function.\n  
/// Option usage is summarized below: \n
/// \verbatim
...
/// \endverbatim
/// The second kind of command line tokens are \e arguments to the application.
...
public:
  ...
  /// is MPI.  MPI_Init(&argc,&argv) should be invoked before *this* object is 
  /// constructed.
  ///
  ComLineObject(const char *args[]){
    Record(args);
  };
  /// \brief One fell swoop processing of command line.
